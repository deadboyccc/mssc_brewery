...
* The original package name 'dev.dead.mssc-brewery' is invalid and this project uses 'dev.dead.mssc_brewery' instead.
...
### Following Guru course on microservices/Spring Cloud
 -> 4-8